					...
					<div class="column eleven wide right aligned content">
						<svg id="carte-rb"
							...
							<g id="reserves-off" class="ui">
								...
								<path style="cursor:pointer" data-reserve="fango"           id="fango" 					class="cls-2" d="M856.36,571.9c4,1.79,6.1,7.11,4.8,12.24l-1.44,1.44c-5.4.16-9.29-2.68-9.12-8.16C852,574.56,854,573.75,856.36,571.9Z" transform="translate(-137.13 -112.78)"/>
							...
							<g id="reserves-on">
								...
								<path  	id="fango-on" 					data-reserve="fango-on"    				class="fango-on cls-17" d="M856.36,571.9c4,1.79,6.1,7.11,4.8,12.24l-1.44,1.44c-5.4.16-9.29-2.68-9.12-8.16C852,574.56,854,573.75,856.36,571.9Z" transform="translate(-137.13 -112.78)"/>
