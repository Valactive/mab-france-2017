(function() {
	...
	var names = {
		text: ['status', 'statut','published', 'veröffentlicht', 'état', 'publié', 'pubblicato', 'zverejnené'],
		date: ['date', 'publish date', 'Datum', 'Veröffentlichungsdatum', 'Zeitraum', 'Anzeigezeitraum', 'Dátum', 'Dátum zverejnenia']
	};

	var values = ['Fait','yes', 'published', 'activated', 'enabled', 'visible', 'open', 'ja', 'veröffentlicht', 'aktiviert', 'freigeschaltet', 'offen', 'sichtbar', 'publié', 'oui', 'pubblicato', 'áno'];
